...
class _NotificationsPageState extends ConsumerState<NotificationsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final published =
        ref.watch(manasaknaNotificationsProvider).asData?.value ?? const [];
      ...
      child: Column(
        ...
        children: [
          InfoSectionCard(
            ...
            subtitle:
                'تنبيهات إرشادية مبنية على مصفوفة الحج v6. لا تُرسل إشعارات خارج الجهاز في هذه المرحلة.',
            icon: Icons.notifications_active_outlined,
            trailing: MunasaknaStatusChip(
                label: '$enabledCount مفعل', icon: Icons.check_circle_outline),
            children: [
              LinearProgressIndicator(
                  value: enabledCount / _localReminders.length),
              const SizedBox(height: 10),
              const Text(
                  'لاحقًا، عند الربط مع نسك، ستُضبط المواعيد حسب برنامج الشركة والتفويج الفعلي. حاليًا هذه تنبيهات تعليمية/تجريبية.'),
            ],
          ),
          const SizedBox(height: 12),
          if (published.isNotEmpty) ...[
            InfoSectionCard(
              title: 'تنبيهات الموسم المنشورة',
              subtitle: 'قادمة من Backend مناسكنا المستقل.',
...
class _ReminderTile extends StatelessWidget {
  const _ReminderTile(
      {required this.reminder, required this.enabled, required this.onChanged});
...
const _localReminders = [
  _LocalReminder(
      id: 'docs',
      group: 'قبل السفر',
      title: 'راجع الوثائق والجواز',
      timeLabel: 'قبل السفر',
      message:
          'تأكد من الجواز، التصريح، بطاقة الحملة، وأرقام التواصل قبل التوجه إلى نقطة التجمع.',
      icon: Icons.description_outlined),
  _LocalReminder(
      id: 'health',
      group: 'قبل السفر',
      title: 'جهّز الأدوية والمعلومات الصحية',
      timeLabel: 'قبل السفر',
      message:
          'احمل أدويتك الأساسية واكتب معلوماتك الصحية المهمة في مكان واضح.',
      icon: Icons.medication_outlined),
  _LocalReminder(
      id: 'miqat',
      group: 'الإحرام والميقات',
      title: 'استعد للميقات',
      timeLabel: 'قبل الميقات',
      message:
          'حدد نوع النسك، راجع النية التعليمية، وتذكر محظورات الإحرام قبل الوصول إلى الميقات.',
  ...
  _LocalReminder(
      ...
      group: 'الإحرام والميقات',
      title: 'أنت الآن محرم',
      timeLabel: 'بعد الإحرام',
      message:
          'أكثر من التلبية، وابتعد عن محظورات الإحرام، واسأل اللجنة الشرعية عند وجود حالة خاصة.',
  ...
  _LocalReminder(
      ...
      message:
          'الوقوف بعرفة ركن الحج الأعظم؛ الزم مجموعتك وأكثر من الدعاء والذكر حتى وقت النفرة.',
  ...
  _LocalReminder(
      ...
      message:
          'اتبع التفويج، استرح قدر المستطاع، وجهز نفسك لرمي جمرة العقبة يوم النحر.',
      icon: Icons.nightlight_outlined),
  _LocalReminder(
      id: 'jamarat',
      group: 'أيام الحج',
      title: 'رمي الجمرات',
      timeLabel: 'أيام التشريق',
      message:
          'التزم بوقت التفويج، لا تذهب منفردًا، وتجنب المزاحمة حفاظًا على السلامة.',
      icon: Icons.route_outlined),
  _LocalReminder(
      id: 'lost',
      group: 'السلامة والطوارئ',
      title: 'عند الضياع عن المجموعة',
      timeLabel: 'في أي وقت',
      message:
          'ابق في مكان آمن، افتح موقعي الحالي، واتصل بالمشرف أو رقم الطوارئ.',
