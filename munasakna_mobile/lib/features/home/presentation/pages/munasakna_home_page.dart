          ...
          child: ListView(
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(
                    fontSize: 1, height: 0.01, color: Colors.transparent),
              ),
            ],
          ),
        ),
        ...
        ClipPath(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(
                  color: MunasaknaTheme.kiswahGold.withValues(alpha: 0.38),
                  width: 1.1),
            ),
            ...
            children: [
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.titleMedium?.copyWith(
                      color:
                          MunasaknaTheme.deepHaramGreen.withValues(alpha: 0.86),
                      fontWeight: FontWeight.w700,
                      height: 1.55,
                    ),
              ),
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GridView.builder(
          key: const ValueKey<String>('quick-services-grid'),
          shrinkWrap: true,
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            width: double.infinity,
            decoration: BoxDecoration(
                color: MunasaknaTheme.deepHaramGreen.withValues(alpha: 0.32)),
          ),
          Padding(
...
class _HaramArchClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.cubicTo(size.width * 0.10, size.height * 0.18, size.width * 0.23,
        size.height * 0.18, size.width * 0.35, size.height * 0.29);
    path.cubicTo(size.width * 0.43, size.height * 0.36, size.width * 0.55,
        size.height * 0.36, size.width * 0.63, size.height * 0.25);
    path.cubicTo(size.width * 0.73, size.height * 0.12, size.width * 0.88,
        size.height * 0.15, size.width, size.height * 0.28);
